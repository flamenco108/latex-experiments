...
help(){
	echo "This command-line interface is a replacement for the manipulation of a makefile. Please visit http://textallion.googlecode.com for more information about textallion."
	pause
	introduction
}
...
if [ -e ${TEXTALLIONDOCSPATH} ]; then 
	printf "Here are your already existing documents:\n  \n"
	...
	printf "It's probably the first time you're using textallion. We'll make you create a new document now. \n"
	pause
	create_new_doc
fi
}
...
create_new_doc(){
banner
printf "This script will initiate a new document. All requested data are mandatory, except for the tags and the language code.\n\n"
...
create_new_cyoa(){
banner
printf "This script will initiate a new CYOA game. All requested data are mandatory, except for the tags and the language code.\n\n"
...
banner
if [ -e ${TEXTALLIONDOCSPATH} ]; then 
	printf "Here are your already existing games:\n  \n"
	#ls ${TEXTALLIONDOCSPATH}/
	...
	printf "It's probably the first time you're using textallion. We'll make you create a new game now. \n"
	pause
	create_new_cyoa
fi
}
...
create_new_lettre(){
banner
printf "This script will initiate a new lettre. All requested data are mandatory, except for the tags and the language code.\n\n"
...
banner
if [ -e ${TEXTALLIONDOCSPATH} ]; then 
	printf "Here are your already existing lettres:\n  \n"
	#ls ${TEXTALLIONDOCSPATH}/
...
printf ${CYOAINIT} >> ${TEXTALLIONDOCSPATH}/${DOCUMENTFOLDER}/${DOCUMENTFOLDER}.t2t
